        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessControl = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectMembers_Users_AddedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: true),
                    ProjectMemberRole = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FormPermissions_Users_GrantedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormVersion = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormPermissions_GrantedById",
                table: "FormPermissions",
                column: "GrantedById");

            migrationBuilder.CreateIndex(
                name: "IX_FormPermissions_PermissionType",
                table: "FormPermissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormSubmissions_ProjectId",
                table: "FormSubmissions",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormTemplates_UsageCount",
                table: "FormTemplates",
                column: "UsageCount");
